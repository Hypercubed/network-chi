...
export default function ThreeNetwork (opts) {
  ...
  let width = opts.width || (960 - margin.left - margin.right);
      ...
      container.addEventListener('mousedown', event => {
        ...
        if (event.which === 3) {  // right click
          ...
          if (intersects) {
            ...
            return dispatch.call('contextmenu', container, event, intersects);
          }
        }
        return dispatch.call('contextmenu', container, event, null);
      });
